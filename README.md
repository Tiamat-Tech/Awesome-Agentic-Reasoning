...
- [Awesome Agentic Reasoning Papers](#awesome-agentic-reasoning-papers)
  ...
  - [5. 👥 Collective Multi-agent Reasoning](#5--collective-multi-agent-reasoning)
    - [🤝 5.2 Collaboration and Division of Labor](#-52-collaboration-and-division-of-labor)
      - [5.2.1 In-context Collaboration](#521-in-context-collaboration)
        - [Manually Crafted Pipelines](#manually-crafted-pipelines)
        - [LLM-Driven Pipelines](#llm-driven-pipelines)
        - [Theory-of-Mind-Augmented Collaboration](#theory-of-mind-augmented-collaboration)
      - [5.2.2 Post-training Collaboration](#522-post-training-collaboration)
        - [Multi-agent Prompt Optimization](#multi-agent-prompt-optimization)
        - [Graph-based Topology Generation](#graph-based-topology-generation)
        - [Policy-based Topology Generation](#policy-based-topology-generation)
    - [🌱 5.3 Multi-Agent Evolution](#-53-multi-agent-evolution)
      - [5.3.1 From Single-Agent Evolution to Multi-Agent Evolution](#531-from-single-agent-evolution-to-multi-agent-evolution)
        - [Intra-test-time Evolution](#intra-test-time-evolution)
        - [Inter-test-time Evolution](#inter-test-time-evolution)
  ...
  - [6. 🎨 Applications](#6--applications)
    - [💻 6.1 Math Exploration \& Vibe Coding Agents](#-61-math-exploration--vibe-coding-agents)
      - [Foundational Agentic Reasoning](#foundational-agentic-reasoning)
    ...
    - [🔬 6.2 Scientific Discovery Agents](#-62-scientific-discovery-agents)
      - [Foundational Agentic Reasoning](#foundational-agentic-reasoning-1)
      - [Self-evolving Agentic Reasoning](#self-evolving-agentic-reasoning-1)
      - [Collective multi-agent reasoning](#collective-multi-agent-reasoning-1)
    - [🤖 6.3 Embodied Agents](#-63-embodied-agents)
      - [Foundational Agentic Reasoning](#foundational-agentic-reasoning-2)
      - [Self-evolving Agentic Reasoning](#self-evolving-agentic-reasoning-2)
      - [Collective multi-agent reasoning](#collective-multi-agent-reasoning-2)
    - [⚕️ 6.4 Healthcare \& Medicine Agents](#️-64-healthcare--medicine-agents)
      - [Foundational agentic reasoning](#foundational-agentic-reasoning-3)
      - [Self-evolving agentic reasoning](#self-evolving-agentic-reasoning-3)
      - [Collective multi-agent reasoning](#collective-multi-agent-reasoning-3)
    - [🌐 6.5 Autonomous Web Exploration \& Research Agents](#-65-autonomous-web-exploration--research-agents)
      - [Foundational agentic reasoning](#foundational-agentic-reasoning-4)
      - [Self-evolving agentic reasoning](#self-evolving-agentic-reasoning-4)
      - [Collective multi-agent reasoning](#collective-multi-agent-reasoning-4)
  - [7. 📊 Benchmarks](#7--benchmarks)
    - [⚙️ 7.1 Core Mechanisms of Agentic Reasoning](#️-71-core-mechanisms-of-agentic-reasoning)
      - [7.1.1 Tool Use](#711-tool-use)
        - [Single-Turn Tool Use](#single-turn-tool-use)
        - [Multi-Turn Tool Use](#multi-turn-tool-use)
      - [7.1.2 Memory](#712-memory)
        - [Long-Horizon Episodic Memory](#long-horizon-episodic-memory)
        - [Multi-session Recall](#multi-session-recall)
      - [7.1.3 Multi-Agent System](#713-multi-agent-system)
        - [Game-based reinforcement learning evaluation](#game-based-reinforcement-learning-evaluation)
      - [Simulation-centric real-world assessment](#simulation-centric-real-world-assessment)
      - [Language, Communication, and Social Reasoning](#language-communication-and-social-reasoning)
